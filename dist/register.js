...
import { BASE_URL, BROKER_ID, CHAIN_ID } from './config.js';
import { messageTypes } from './eip712.js';
...
export async function registerAccount(wallet) {
    ...
    const signature = await wallet.signTypedData(offchainDomain, {
...
export async function addAccessKey(wallet) {
